...
function imprimirDespesas(despesas) {
  ...
  //forEach usar ou modificar array original
  despesas.forEach((despesa) => {
    divDespesas.innerHTML += `<p>valor: R$ ${despesa.valor} | tipo: ${despesa.tipo} | descrição: ${despesa.descricao} </p> `;
  }); // imprimir um valor para cada item do parametro de despesas
}
...
function filtrarDespesas() {
  ...
  imprimirDespesas(despesasFiltradas) = arrDespesas.filter ((despesas) => {
